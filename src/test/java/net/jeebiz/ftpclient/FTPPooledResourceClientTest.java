...
public class FTPPooledResourceClientTest extends FTPClientTest {
	...
	public void setUp() {
		...
		#===============================================================================
		#ftp服务器地址
		ftpclient.host = 121.43.110.87
		#ftp服务器端口
		ftpclient.port = 21
		#ftp服务器用户名
		ftpclient.username = www
		#ftp服务器密码
		ftpclient.password = cFcB10bug
		#ftp服务器根路径
		...
		ftpclient.copyStreamProcessListenerName = com.firefly.ftpclient.io.PrintCopyStreamProcessListener
