...
import net.jeebiz.ftpclient.metrics.FTPClientMetricsFactory;
import net.jeebiz.ftpclient.utils.FTPConnectUtils;
import net.jeebiz.ftpclient.utils.FTPPathUtils;
...
public class FTPPooledClientFactory extends BasePooledObjectFactory<FTPClient> {
	...
	protected FTPClientBuilder clientBuilder;
	...
	public FTPClient create() throws Exception {
		...
		FTPClientMetricsFactory.getMeter(FTPClient.class, "create").mark();
		FTPClientMetricsFactory.getCounter(FTPClient.class, "count").inc();
		return ftpClient;
	}
	...
	public void destroyObject(PooledObject<FTPClient> poolObject) throws Exception {
		...
		FTPClientMetricsFactory.getCounter(FTPClient.class, "count").dec();
		FTPClientMetricsFactory.getMeter(FTPClient.class, "destroy").mark();
	}
