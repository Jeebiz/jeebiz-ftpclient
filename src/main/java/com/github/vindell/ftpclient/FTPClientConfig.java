...
import com.github.vindell.ftpclient.enums.FTPServerTypeEnum;
import com.github.vindell.ftpclient.enums.FileFormatEnum;
import com.github.vindell.ftpclient.enums.FileStructureEnum;
import com.github.vindell.ftpclient.enums.FileTransferModeEnum;
import com.github.vindell.ftpclient.enums.FileTypeEnum;
...
public class FTPClientConfig extends org.apache.commons.net.ftp.FTPClientConfig {
	...
	public void setFileStructure(FileStructureEnum fileStructure) {
	...
	public FTPServerTypeEnum getServerType() {
		return serverType;
	}

	public void setServerType(FTPServerTypeEnum serverType) {
