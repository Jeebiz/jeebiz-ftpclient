...
import net.jeebiz.ftpclient.filefilter.AgeFileFilter;
import net.jeebiz.ftpclient.filefilter.AndFileFilter;
import net.jeebiz.ftpclient.filefilter.DelegateFileFilter;
import net.jeebiz.ftpclient.filefilter.FalseFileFilter;
import net.jeebiz.ftpclient.filefilter.FileFileFilter;
import net.jeebiz.ftpclient.filefilter.MagicNumberFileFilter;
import net.jeebiz.ftpclient.filefilter.NameFileFilter;
import net.jeebiz.ftpclient.filefilter.NotFileFilter;
import net.jeebiz.ftpclient.filefilter.OrFileFilter;
import net.jeebiz.ftpclient.filefilter.PrefixFileFilter;
import net.jeebiz.ftpclient.filefilter.SizeFileFilter;
import net.jeebiz.ftpclient.filefilter.SuffixFileFilter;
import net.jeebiz.ftpclient.filefilter.TrueFileFilter;
