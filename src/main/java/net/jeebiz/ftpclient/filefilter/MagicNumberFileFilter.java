...
public class MagicNumberFileFilter  implements FTPFileFilter ,Serializable {
	...
	*/
	public MagicNumberFileFilter(FTPClient ftpClient,final byte[] magicNumber) {
		this(ftpClient , magicNumber, 0);
	}
	...
	*/
	public MagicNumberFileFilter(FTPClient ftpClient,final String magicNumber) {
		this(ftpClient , magicNumber, 0);
	}
	...
	*         a negative number.
	*/
	public MagicNumberFileFilter(FTPClient ftpClient,final String magicNumber, final long offset) {
		if (magicNumber == null) {
	...
	*/
	public MagicNumberFileFilter(FTPClient ftpClient,final byte[] magicNumber, final long offset) {
		if (magicNumber == null) {
		    throw new IllegalArgumentException("The magic number cannot be null");
		}
	...
	*/
	...
	public boolean accept(final FTPFile file) {
		if (file != null && file.isFile() && file.isValid()) {
		    ...
		    try {
	        	...
	        	this.ftpClient.retrieveFile(file.getName(), output);
	        	output.flush();
